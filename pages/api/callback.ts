...
export default async (req, res) => {
  ...
  const result: OAuthTokenResponse = await axios({
    ...
    data: `client_assertion_type=urn:ietf:params:oauth:client-assertion-type:jwt-bearer&client_assertion=${clientSecret}&grant_type=urn:ietf:params:oauth:grant-type:jwt-bearer&assertion=${code}&redirect_uri=https%3A%2F%2F${process.env.HOST_URL}%3A3000%2Fapi%2Fcallback`,
