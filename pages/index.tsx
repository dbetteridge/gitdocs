      ...
      <Row style={{ width: "100%" }}>
        ...
        <Col md={12} xs={20}>
          ...
          <Paragraph>
            <ul>
              <li>
                You can share your document spaces with anyone regardless of
                their access to your git repositories
              </li>
              <li>
                The markdown files are downloaded, converted to HTML and stored
                in an access controlled database
              </li>
              <li>
                Styling is applied at load to make them readable on mobile,
                tablet and desktop
              </li>
